...
const positive = + prompt("Введите положительное значение:");
const negative = + prompt("Введите отрицательное значение:");
(negative < 0 && positive > 0) ? console.log("Все значения верные.")
